...
namespace YYT.Silverlight.Security
{  
  //[MobileFactory("YYT.Security.IdentityFactory,YYT", "FetchWindowsIdentity")]
  /// <summary>
  /// Base class to simplify the retrieval of Windows identity
  /// information from a Windows server to a 
  /// YYT .NET for Silverlight client.
  /// </summary>
  [Serializable()]
  public abstract class WindowsIdentity : ReadOnlyBase<WindowsIdentity>,
      System.Security.Principal.IIdentity, YYT.Security.ICheckRoles
  {
