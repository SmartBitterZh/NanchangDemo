...
namespace YYT
{
  ...
  public static class ApplicationContext
  {
        ...
        else if (System.Windows.Application.Current != null)
        {
          if (_principal == null)
          {
            if (ApplicationContext.AuthenticationType != "Windows")
              _principal = new YYT.Security.UnauthenticatedPrincipal();
            else
    ...
    private const string _localContextName = "YYT.LocalContext";
    ...
    private const string _clientContextName = "YYT.ClientContext";
    private const string _globalContextName = "YYT.GlobalContext";
    ...
    /// file with the key value "YYTAuthentication". The value
    /// "Windows" indicates YYT .NET should use Windows integrated
    ...
    public static string AuthenticationType
    {
      get 
      {
        ...
        {
          _authenticationType = ConfigurationManager.AppSettings["YYTAuthentication"];
          _authenticationType = _authenticationType ?? "YYT";
        }
    ...
    /// <para>
    /// This value is read from the application configuration
    /// file with the key value "YYTDataPortalProxy". 
    /// </para><para>
    /// The proxy class must implement YYT.Server.IDataPortalServer.
    /// </para><para>
    ...
    /// <list>
    /// <item>
    /// <term>YYT,YYT.DataPortalClient.RemotingProxy</term>
    /// <description>Use .NET Remoting to communicate with the server</description>
    /// </item>
    /// <item>
    /// <term>YYT,YYT.DataPortalClient.EnterpriseServicesProxy</term>
    /// <description>Use Enterprise Services (DCOM) to communicate with the server</description>
    /// </item>
    /// <item>
    /// <term>YYT,YYT.DataPortalClient.WebServicesProxy</term>
    ...
    public static string DataPortalProxy
    {
      get
      {
        string result = ConfigurationManager.AppSettings["YYTDataPortalProxy"];
    ...
    /// <remarks>
    /// This value is read from the application configuration
    /// file with the key value "YYTDataPortalUrl". 
    /// </remarks>
    public static Uri DataPortalUrl
    {
      get { return new Uri(ConfigurationManager.AppSettings["YYTDataPortalUrl"]); }
    }
    ...
    public static string IsInRoleProvider
    {
      get
      {
        string result = ConfigurationManager.AppSettings["YYTIsInRoleProvider"];
        if (string.IsNullOrEmpty(result))
          result = string.Empty;
        return result;
      }
    ...
    public static bool AutoCloneOnUpdate
    {
      ...
      {
        bool result = true;
        string setting = ConfigurationManager.AppSettings["YYTAutoCloneOnUpdate"];
    ...
    /// <summary>
    /// Gets the serialization formatter type used by YYT .NET
    ...
    public static SerializationFormatters SerializationFormatter
    {
      get
      {
        string tmp = ConfigurationManager.AppSettings["YYTSerializationFormatter"];
    ...
    /// <summary>
    /// Gets or sets a value specifying how YYT .NET should
    ...
    public static PropertyChangedModes PropertyChangedMode
    {
      get
      {
        ...
        {
          string tmp = ConfigurationManager.AppSettings["YYTPropertyChangedMode"];
          if (string.IsNullOrEmpty(tmp))
            tmp = "Windows";
    ...
    /// <summary>
    /// Enum representing the way in which YYT .NET
