...
namespace YYT.Security
{
  ...
  public class AuthorizationRules
  {
    ...
    public static bool CanCreateObject(Type objectType)
    {
      ...
      var allow = YYT.Security.AuthorizationRules.GetAllowCreateRoles(objectType);
      if (allow != null)
      {
        if (!YYT.Security.AuthorizationRulesManager.PrincipalRoleInList(principal, allow))
          result = false;
      }
      else
      {
        var deny = YYT.Security.AuthorizationRules.GetDenyCreateRoles(objectType);
        if (deny != null)
        {
          if (YYT.Security.AuthorizationRulesManager.PrincipalRoleInList(principal, deny))
            result = false;
        }
      }
      return result;
    ...
    public static bool CanGetObject(Type objectType)
    {
      bool result = true;
      var principal = ApplicationContext.User;
      var allow = YYT.Security.AuthorizationRules.GetAllowGetRoles(objectType);
      if (allow != null)
      {
        if (!YYT.Security.AuthorizationRulesManager.PrincipalRoleInList(principal, allow))
          result = false;
      ...
      {
        var deny = YYT.Security.AuthorizationRules.GetDenyGetRoles(objectType);
        if (deny != null)
        {
          if (YYT.Security.AuthorizationRulesManager.PrincipalRoleInList(principal, deny))
            result = false;
    ...
    public static bool CanEditObject(Type objectType)
    {
      bool result = true;
      var principal = ApplicationContext.User;
      var allow = YYT.Security.AuthorizationRules.GetAllowEditRoles(objectType);
      if (allow != null)
      {
        if (!YYT.Security.AuthorizationRulesManager.PrincipalRoleInList(principal, allow))
          result = false;
      ...
      {
        var deny = YYT.Security.AuthorizationRules.GetDenyEditRoles(objectType);
        if (deny != null)
        {
          if (YYT.Security.AuthorizationRulesManager.PrincipalRoleInList(principal, deny))
            result = false;
    ...
    public static bool CanDeleteObject(Type objectType)
    {
      bool result = true;
      var principal = ApplicationContext.User;
      var allow = YYT.Security.AuthorizationRules.GetAllowDeleteRoles(objectType);
      if (allow != null)
      {
        if (!YYT.Security.AuthorizationRulesManager.PrincipalRoleInList(principal, allow))
          result = false;
      ...
      {
        var deny = YYT.Security.AuthorizationRules.GetDenyDeleteRoles(objectType);
        if (deny != null)
        {
          if (YYT.Security.AuthorizationRulesManager.PrincipalRoleInList(principal, deny))
            result = false;
