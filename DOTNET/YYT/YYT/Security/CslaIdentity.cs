...
namespace YYT.Security
{
  ...
  /// </summary>
  [Serializable()]
  public abstract partial class YYTIdentity : ReadOnlyBase<YYTIdentity>, IIdentity, ICheckRoles
  {
    ...
    /// </summary>
    /// <returns></returns>
    public static YYTIdentity UnauthenticatedIdentity()
    {
      return new YYT.Security.UnauthenticatedIdentity();
    }
    #endregion
    ...
    private static readonly PropertyInfo<string> AuthenticationTypeProperty = 
      RegisterProperty<string>(new PropertyInfo<string>("AuthenticationType", "Authentication type", "YYT"));
    /// <summary>
