...
using YYT.DataPortalClient;
using YYT.Silverlight;
using YYT.Core;
...
namespace YYT.Security
{
  ...
  /// </summary>
  [Serializable()]
  [MobileFactory("YYT.Security.IdentityFactory,YYT", "FetchMembershipIdentity")]
  public partial class MembershipIdentity : ReadOnlyBase<MembershipIdentity>, IIdentity, ICheckRoles
  {
    ...
    /// </summary>
    [Serializable()]
    public class Criteria : YYT.Core.MobileObject
    {
      private Criteria() { }
      /// <summary>
      ...
      protected override void OnGetState(YYT.Serialization.Mobile.SerializationInfo info, YYT.Core.StateMode mode)
      {
      ...
      /// <param name="info">Serialization info.</param>
      /// <param name="mode">Serialization mode.</param>
      protected override void OnSetState(YYT.Serialization.Mobile.SerializationInfo info, YYT.Core.StateMode mode)
      {
