...
namespace YYT
{
  ...
  /// </remarks>
  [Serializable()]
  [System.ComponentModel.TypeConverter(typeof(YYT.Core.TypeConverters.SmartDateConverter))]
  public struct SmartDate : YYT.Core.ISmartField,
    IComparable, IConvertible, IFormattable, YYT.Serialization.Mobile.IMobileObject
  {
    ...
    {
      _emptyValue = YYT.SmartDate.EmptyValue.MinDate;
      _format = null;
      _initialized = false;
      _date = DateTime.MinValue;
      Date = value;
