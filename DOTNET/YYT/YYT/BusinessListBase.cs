...
namespace YYT
{
    ...
    where C : Core.IEditableBusinessObject
  {
    ...
    public virtual bool IsSavable
    {
      get 
      {
        bool auth = YYT.Security.AuthorizationRules.CanEditObject(this.GetType());
    ...
    void Core.IEditableCollection.RemoveChild(YYT.Core.IEditableBusinessObject child)
    {
    ...
    /// </summary>
    /// <param name="child">The child object to remove.</param>
    void Core.IParent.RemoveChild(YYT.Core.IEditableBusinessObject child)
    {
      RemoveFromMap((C)child);
      Remove((C)child);
      RemoveIndexItem((C)child);
    ...
    {
      if (_indexSet == null) _indexSet = new YYT.Linq.IndexSet<C>();
    }

    /// <summary>
    /// Allows users of YYT to override the indexing behavior of BLB
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Advanced)]
    ...
    {
      if (_positionMap == null) _positionMap = new YYT.Core.PositionMap<C>(this);
    }
    ...
    object YYT.Core.ISavable.Save()
    {
      return Save();
    }

    void YYT.Core.ISavable.SaveComplete(object newObject)
    {
    ...
    [NonSerialized()]
    [NotUndoable]
    private EventHandler<YYT.Core.SavedEventArgs> _nonSerializableSavedHandlers;
    [NotUndoable]
    private EventHandler<YYT.Core.SavedEventArgs> _serializableSavedHandlers;
    ...
    public event EventHandler<YYT.Core.SavedEventArgs> Saved
    {
      add
      {
        if (value.Method.IsPublic &&
          ...
          _serializableSavedHandlers = (EventHandler<YYT.Core.SavedEventArgs>)
            System.Delegate.Combine(_serializableSavedHandlers, value);
        else
          _nonSerializableSavedHandlers = (EventHandler<YYT.Core.SavedEventArgs>)
    ...
    {
      YYT.Core.SavedEventArgs args = new YYT.Core.SavedEventArgs(newObject, e, userState);
    ...
    {
      _queryProvider = new YYT.Linq.YYTQueryProvider<T, C>(this);
    }
    ...
    {
      get {
        return new Linq.YYTQueryProvider<T, C>(this);
      }
    }
    ...
    /// </param>
    [System.ComponentModel.EditorBrowsable(EditorBrowsableState.Advanced)]
    protected override void OnSetState(YYT.Serialization.Mobile.SerializationInfo info)
    {
      _isChild = info.GetValue<bool>("YYT.BusinessListBase._isChild");
      _editLevel = info.GetValue<int>("YYT.BusinessListBase._editLevel");
    ...
    /// </param>
    [System.ComponentModel.EditorBrowsable(EditorBrowsableState.Advanced)]
    protected override void OnGetState(YYT.Serialization.Mobile.SerializationInfo info)
    {
      info.AddValue("YYT.BusinessListBase._isChild", _isChild);
      info.AddValue("YYT.BusinessListBase._editLevel", _editLevel);
    ...
    /// </param>
    [System.ComponentModel.EditorBrowsable(EditorBrowsableState.Advanced)]
    protected override void OnGetChildren(YYT.Serialization.Mobile.SerializationInfo info, YYT.Serialization.Mobile.MobileFormatter formatter)
    {
