...
namespace YYT.Wpf
{
  ...
  public class DataDecoratorBase : Decorator
  {
    ...
    private void UnHookDataContextEvents(object oldValue)
    {
      ...
      UnHookChildChanged(oldContext as YYT.Core.INotifyChildChanged);
    ...
    private void HookDataContextEvents(object newValue)
    {
      ...
      HookChildChanged(newContext as YYT.Core.INotifyChildChanged);
    ...
    private void UnHookChildChanged(YYT.Core.INotifyChildChanged oldContext)
    {
      if (oldContext != null)
        oldContext.ChildChanged -= DataObject_ChildChanged;
    }

    private void HookChildChanged(YYT.Core.INotifyChildChanged newContext)
    {
      if (newContext != null)
    ...
    private void DataObject_ChildChanged(object sender, YYT.Core.ChildChangedEventArgs e)
    {
