...
{
  /// <summary>
  /// Wraps and creates a YYT .NET-style object 
  /// that you can use as a binding source.
  /// </summary>
  public class YYTDataProvider : DataSourceProvider
  {
    ...
    private YYTDataProviderCommandManager _commandManager;
    private bool _isBusy;

    /// <summary>
    /// Gets an object that can be used to execute
    /// Save and Undo commands on this YYTDataProvider 
    /// through XAML command bindings.
    /// </summary>
    public YYTDataProviderCommandManager CommandManager
    {
      get
      {
