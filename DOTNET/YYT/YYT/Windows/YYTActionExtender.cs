...
namespace YYT.Windows
{
  ...
  /// data binding to YYT .NET business objects.
  /// </summary>
  [ToolboxItem(true)]
  ...
  public class YYTActionExtender : Component, IExtenderProvider
  {
    #region Constants
    ...
    private const string STR_InvalidBusinessObjectBaseCast = "The underlying data source does not cast to a YYT BusinessBase object.";
    ...
    public YYTActionExtender(IContainer container)
      : base()
    {
    ...
    private Dictionary<Control, YYTActionExtenderProperties> _Sources = 
      new Dictionary<Control, YYTActionExtenderProperties>();
    ...
    [Bindable(true)]
    [DefaultValue(YYTFormAction.None)]
    public YYTFormAction GetActionType(Control ctl)
    {
      if (_Sources.ContainsKey(ctl))
        return ((YYTActionExtenderProperties)_Sources[ctl]).ActionType;
      else
        return YYTActionExtenderProperties.ActionTypeDefault;
    }
    ...
    [Bindable(true)]
    [DefaultValue(YYTFormAction.None)]
    public void SetActionType(Control ctl, YYTFormAction value)
    {
      if (_Sources.ContainsKey(ctl))
        _Sources[ctl].ActionType = value;
      else
      {
        YYTActionExtenderProperties props = new YYTActionExtenderProperties();
    ...
    {
      if (_Sources.ContainsKey(ctl))
        return ((YYTActionExtenderProperties)_Sources[ctl]).PostSaveAction;
      else
        return YYTActionExtenderProperties.PostSaveActionDefault;
    }
    ...
    {
      if (_Sources.ContainsKey(ctl))
        return ((YYTActionExtenderProperties)_Sources[ctl]).RebindAfterSave;
      else
        return YYTActionExtenderProperties.RebindAfterSaveDefault;
    }
    ...
    {
      if (_Sources.ContainsKey(ctl))
        return ((YYTActionExtenderProperties)_Sources[ctl]).DisableWhenClean;
      else
        return YYTActionExtenderProperties.DisableWhenCleanDefault;
    }
    ...
    {
      if (_Sources.ContainsKey(ctl))
        return ((YYTActionExtenderProperties)_Sources[ctl]).CommandName;
      else
        return YYTActionExtenderProperties.CommandNameDefault;
    }
    ...
    public event EventHandler<YYTActionCancelEventArgs> Clicking;
    ...
    public event EventHandler<YYTActionEventArgs> Clicked;
    ...
    public event EventHandler<YYTActionEventArgs> SetForNew;
    ...
    public event EventHandler<YYTActionEventArgs> BusinessObjectInvalid;
    ...
    public event EventHandler<YYTActionCancelEventArgs> ObjectSaving;
    ...
    public event EventHandler<YYTActionEventArgs> ObjectSaved;
    ...
    protected virtual void OnClicking(YYTActionCancelEventArgs e)
    {
      if (Clicking != null)
        Clicking(this, e);
    }
    ...
    /// </summary>
    /// <param name="e">Event arguments.</param>
    protected virtual void OnClicked(YYTActionEventArgs e)
    {
      if (Clicked != null)
        Clicked(this, e);
    }
    ...
    /// </summary>
    /// <param name="e">Event arguments.</param>
    protected virtual void OnSetForNew(YYTActionEventArgs e)
    {
      if (SetForNew != null)
        SetForNew(this, e);
    }
    ...
    /// </summary>
    /// <param name="e">Event arguments.</param>
    protected virtual void OnBusinessObjectInvalid(YYTActionEventArgs e)
    {
    ...
    /// </summary>
    /// <param name="e">Event arguments.</param>
    protected virtual void OnObjectSaving(YYTActionCancelEventArgs e)
    {
    ...
    /// </summary>
    /// <param name="e">Event arguments.</param>
    protected virtual void OnObjectSaved(YYTActionEventArgs e)
    {
      if (ObjectSaved != null)
        ObjectSaved(this, e);
    }
    ...
    protected void OnClick(object sender, System.EventArgs e)
    {
      ...
      YYTActionExtenderProperties props = _Sources[ctl] as YYTActionExtenderProperties;
      if (props.ActionType != YYTFormAction.None)
      {
        try
        {
          bool raiseClicked = true;
          YYTActionCancelEventArgs args = new YYTActionCancelEventArgs(false, props.CommandName);
          OnClicking(args);
          if (!args.Cancel)
          {
            // perform action
            YYT.Core.ISavable savableObject = null;
            YYT.Core.ITrackStatus trackableObject = null;
            ...
            if (_dataSource != null)
            {
              ...
              if (source != null)
              {
                savableObject = source.DataSource as YYT.Core.ISavable;
                trackableObject = source.DataSource as YYT.Core.ITrackStatus;
              }
              else
            ...
            {
              case YYTFormAction.Save:

                bool okToContinue = true;

                if (savableObject is YYT.Core.BusinessBase)
                {
                  YYT.Core.BusinessBase businessObject = savableObject as YYT.Core.BusinessBase;
                ...
                if (okToContinue)
                {
                  ...
                  if (objectValid)
                  {
                    YYTActionCancelEventArgs savingArgs = new YYTActionCancelEventArgs(
                    ...
                    if (!args.Cancel)
                    {
                      ...
                      //save
                      YYT.Core.ISavable objectToSave = savableObject;

                      if (YYT.ApplicationContext.AutoCloneOnUpdate)
                        objectToSave = ((ICloneable)savableObject).Clone() as YYT.Core.ISavable;

                      if (objectToSave != null)
                      {
                        YYT.Core.ISavable saveableObject = objectToSave as YYT.Core.ISavable;

                        try
                        {
                          savableObject = savableObject.Save() as YYT.Core.ISavable;

                          OnObjectSaved(new YYTActionEventArgs(props.CommandName));
                          ...
                          switch (props.PostSaveAction)
                          {
                            ...
                            case PostSaveActionType.AndNew:
                              ...
                              OnSetForNew(new YYTActionEventArgs(props.CommandName));
                              break;
                          }
                        }
                        catch (Exception ex)
                  ...
                  {
                    OnBusinessObjectInvalid(new YYTActionEventArgs(props.CommandName));
            ...
            if (raiseClicked)
            {
              if (props.ActionType == YYTFormAction.Save && source != null && props.RebindAfterSave)
              {
              ...
              OnClicked(new YYTActionEventArgs(props.CommandName));
            }
          }
    ...
    private void InitializeControls(bool initialEnabling)
    {
      ...
      foreach (KeyValuePair<Control, YYTActionExtenderProperties> pair in _Sources)
      {
        if (pair.Value.ActionType != YYTFormAction.None)
        {
    ...
    private void InitializeControl(Control ctl)
    {
      if (!ctl.Enabled)
      {
        YYT.Core.ISavable businessObject = GetBusinessObject();
        if (businessObject != null)
        {
          YYT.Core.ITrackStatus trackableObject = businessObject as ITrackStatus;
    ...
    private void CloseForm()
    {
      if (_Sources.Count > 0)
      {
        Dictionary<Control, YYTActionExtenderProperties>.Enumerator enumerator = _Sources.GetEnumerator();
    ...
    private YYT.Core.ISavable GetBusinessObject()
    {
      YYT.Core.ISavable businessObject = null;
      BindingSource source = _dataSource as BindingSource;
      if (source != null)
        businessObject = source.DataSource as YYT.Core.ISavable;
