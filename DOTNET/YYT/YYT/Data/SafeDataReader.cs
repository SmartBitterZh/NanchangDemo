...
namespace YYT.Data
{
  ...
  public class SafeDataReader : IDataReader
  {
    ...
    /// </remarks>
    /// <param name="name">Name of the column containing the value.</param>
    public YYT.SmartDate GetSmartDate(string name)
    {
    ...
    /// </remarks>
    /// <param name="i">Ordinal column position of the value.</param>
    public virtual YYT.SmartDate GetSmartDate(int i)
    {
    ...
    public YYT.SmartDate GetSmartDate(string name, bool minIsEmpty)
    {
    ...
    /// A flag indicating whether the min or max 
    /// value of a data means an empty date.</param>
    public virtual YYT.SmartDate GetSmartDate(
      int i, bool minIsEmpty)
    {
      if (_dataReader.IsDBNull(i))
        return new YYT.SmartDate(minIsEmpty);
      else
        return new YYT.SmartDate(
