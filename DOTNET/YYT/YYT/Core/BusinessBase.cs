...
using YYT.Validation;
using System.Collections.ObjectModel;
using YYT.Core.LoadManager;
using YYT.Server;
using YYT.Security;
...
namespace YYT.Core
{
    ...
    ISerializationNotification
  {
    ...
    /// </summary>
    /// <remarks>
    /// YYT .NET supports both immediate and deferred deletion of objects. This
    ...
    /// <remarks>
    /// <para>
    /// When an object's data is changed, YYT .NET makes note of that change
    ...
    /// to tell YYT .NET that the object's data has been changed.
    /// </para><para>
    /// Marking an object as dirty does two things. First it ensures
    /// that YYT .NET will properly save the object as appropriate. Second,
    /// it causes YYT .NET to tell Windows Forms data binding that the
    ...
    /// <see cref="P:YYT.BusinessBase.IsDirty" /> returns <see langword="true" />. It is
    ...
    public virtual bool IsSavable
    {
      get 
      {
        bool auth;
        if (IsDeleted)
          auth = YYT.Security.AuthorizationRules.CanDeleteObject(this.GetType());
        else if (IsNew)
          auth = YYT.Security.AuthorizationRules.CanCreateObject(this.GetType());
        else
          auth = YYT.Security.AuthorizationRules.CanEditObject(this.GetType());
    ...
    private void InitializeAuthorizationRules()
    {
      ...
      if (!(YYT.Security.SharedAuthorizationRules.RulesExistFor(this.GetType())))
      {
        lock (this.GetType())
        {
          if (!(YYT.Security.SharedAuthorizationRules.RulesExistFor(this.GetType())))
          {
            YYT.Security.SharedAuthorizationRules.GetManager(this.GetType(), true);
    ...
    /// </summary>
    /// <remarks>
    /// AddInstanceAuthorizationRules is automatically called by YYT .NET
    ...
    /// </summary>
    /// <remarks>
    /// AddAuthorizationRules is automatically called by YYT .NET
    ...
    protected Validation.ValidationRules ValidationRules
    {
      get
      {
        ...
        {
          _validationRules = new YYT.Validation.ValidationRules(this);
    ...
    /// </summary>
    /// <remarks>
    /// This method is automatically called by YYT .NET
    ...
    /// for this object.
    /// </summary>
    /// <returns>A YYT.Validation.RulesCollection object.</returns>
    [Browsable(false)]
    [EditorBrowsable(EditorBrowsableState.Advanced)]
      ...
      get
      {
        if (!IsSelfValid)
          return ValidationRules.GetBrokenRules().ToString(
            YYT.Validation.RuleSeverity.Error);
        else
          return String.Empty;
      }
    }
    ...
    {
      P result = default(P);
      if (_bypassPropertyChecks || CanReadProperty(propertyInfo.Name, noAccess == YYT.Security.NoAccessBehavior.ThrowException))
    ...
    [NonSerialized]
    [NotUndoable]
    private EventHandler<YYT.Core.ChildChangedEventArgs> _childChangedHandlers;
    ...
    public event EventHandler<YYT.Core.ChildChangedEventArgs> ChildChanged
    {
      add
      {
        _childChangedHandlers = (EventHandler<YYT.Core.ChildChangedEventArgs>)
    ...
    void YYT.Server.IDataPortalTarget.MarkAsChild()
    {
      this.MarkAsChild();
    }

    void YYT.Server.IDataPortalTarget.MarkNew()
    {
      this.MarkNew();
    }

    void YYT.Server.IDataPortalTarget.MarkOld()
    {
      this.MarkOld();
    }

    void YYT.Server.IDataPortalTarget.DataPortal_OnDataPortalInvoke(DataPortalEventArgs e)
    {
      this.DataPortal_OnDataPortalInvoke(e);
    }

    void YYT.Server.IDataPortalTarget.DataPortal_OnDataPortalInvokeComplete(DataPortalEventArgs e)
    {
      this.DataPortal_OnDataPortalInvokeComplete(e);
    }

    void YYT.Server.IDataPortalTarget.DataPortal_OnDataPortalException(DataPortalEventArgs e, Exception ex)
    {
      this.DataPortal_OnDataPortalException(e, ex);
    }

    void YYT.Server.IDataPortalTarget.Child_OnDataPortalInvoke(DataPortalEventArgs e)
    {
      this.Child_OnDataPortalInvoke(e);
    }

    void YYT.Server.IDataPortalTarget.Child_OnDataPortalInvokeComplete(DataPortalEventArgs e)
    {
      this.Child_OnDataPortalInvokeComplete(e);
    }

    void YYT.Server.IDataPortalTarget.Child_OnDataPortalException(DataPortalEventArgs e, Exception ex)
    {
    ...
    /// </param>
    protected override void OnGetState(YYT.Serialization.Mobile.SerializationInfo info, StateMode mode)
    {
      base.OnGetState(info, mode);
      info.AddValue("YYT.Core.BusinessBase._isNew", _isNew);
      info.AddValue("YYT.Core.BusinessBase._isDeleted", _isDeleted);
      info.AddValue("YYT.Core.BusinessBase._isDirty", _isDirty);
      info.AddValue("YYT.Core.BusinessBase._neverCommitted", _neverCommitted);
      info.AddValue("YYT.Core.BusinessBase._disableIEditableObject", _disableIEditableObject);
      info.AddValue("YYT.Core.BusinessBase._isChild", _isChild);
      info.AddValue("YYT.Core.BusinessBase._editLevelAdded", _editLevelAdded);
    }
    ...
    /// The StateMode indicating why this method was invoked.
    /// </param>
    protected override void OnSetState(YYT.Serialization.Mobile.SerializationInfo info, StateMode mode)
    {
      base.OnSetState(info, mode);
      _isNew = info.GetValue<bool>("YYT.Core.BusinessBase._isNew");
      _isDeleted = info.GetValue<bool>("YYT.Core.BusinessBase._isDeleted");
      _isDirty = info.GetValue<bool>("YYT.Core.BusinessBase._isDirty");
      _neverCommitted = info.GetValue<bool>("YYT.Core.BusinessBase._neverCommitted");
      _disableIEditableObject = info.GetValue<bool>("YYT.Core.BusinessBase._disableIEditableObject");
      _isChild = info.GetValue<bool>("YYT.Core.BusinessBase._isChild");
      _editLevelAdded = info.GetValue<int>("YYT.Core.BusinessBase._editLevelAdded");
    }
    ...
    protected override void OnGetChildren(
      YYT.Serialization.Mobile.SerializationInfo info, YYT.Serialization.Mobile.MobileFormatter formatter)
    {
    ...
    /// convert child references to/from reference id values.
    /// </param>
    protected override void OnSetChildren(YYT.Serialization.Mobile.SerializationInfo info, YYT.Serialization.Mobile.MobileFormatter formatter)
    {
      if (info.Children.ContainsKey("_fieldManager"))
      {
        var childData = info.Children["_fieldManager"];
        _fieldManager = (YYT.Core.FieldManager.FieldDataManager)formatter.GetObject(childData.ReferenceId);
      }
