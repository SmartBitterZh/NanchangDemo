  ...
  public class FactoryDataPortal : IDataPortalServer
  {
    ...
    public static IObjectFactoryLoader FactoryLoader
    {
      get
      {
        ...
        {
          string setting = ConfigurationManager.AppSettings["YYTObjectFactoryLoader"];
    ...
    private DataPortalResult InvokeMethod(string factoryTypeName, string methodName, DataPortalContext context)
    {
      ...
      YYT.Reflection.MethodCaller.CallMethodIfImplemented(factory, "Invoke", context);
      object result = null;
      try
      {
        result = YYT.Reflection.MethodCaller.CallMethod(factory, methodName);
        YYT.Reflection.MethodCaller.CallMethodIfImplemented(factory, "InvokeComplete", context);
      }
      catch (Exception ex)
      {
        YYT.Reflection.MethodCaller.CallMethodIfImplemented(factory, "InvokeError", ex);
        throw;
      }
    ...
    private DataPortalResult InvokeMethod(string factoryTypeName, string methodName, object e, DataPortalContext context)
    {
      ...
      try
      {
        result = YYT.Reflection.MethodCaller.CallMethod(factory, methodName, e);
        YYT.Reflection.MethodCaller.CallMethodIfImplemented(factory, "InvokeComplete", context);
      }
      catch (Exception ex)
      {
