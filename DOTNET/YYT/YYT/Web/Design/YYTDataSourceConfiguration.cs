...
{
  /// <summary>
  /// YYTDataSource configuration form.
  /// </summary>
  public partial class YYTDataSourceConfiguration : Form
  {
#if !CLIENTONLY
    ...
    /// </summary>
    public YYTDataSourceConfiguration()
    {
      InitializeComponent();
    }
    ...
    public YYTDataSourceConfiguration(DataSourceControl control, string oldTypeName)
      : this()
    {
      _control = control;
      DiscoverTypes();
    ...
    private void DiscoverTypes()
    {
      ...
      if (discovery != null)
      {
        ...
        try
        {
          ...
          {
            if (type.Assembly.FullName.Substring(0, type.Assembly.FullName.IndexOf(",")) != "YYT" &&
              typeof(YYT.Core.IBusinessObject).IsAssignableFrom(type))
            {
