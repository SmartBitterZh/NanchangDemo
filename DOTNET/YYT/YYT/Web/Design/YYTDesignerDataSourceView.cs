...
namespace YYT.Web.Design
{
  ...
  /// data binding to a specific YYT .NET object.
  /// </summary>
  public class YYTDesignerDataSourceView : DesignerDataSourceView
  {

    private YYTDataSourceDesigner _owner = null;

    /// <summary>
    /// Creates an instance of the object.
    /// </summary>
    public YYTDesignerDataSourceView(YYTDataSourceDesigner owner, string viewName)
      : base(owner, viewName)
    {
      _owner = owner;
    }
    ...
    /// of the YYT .NET business object.
    /// </summary>
    /// <remarks>
    ...
    /// <see cref="YYTDataSource.DeleteObject">DeleteObject</see>
    /// event.
    /// </remarks>
    public override bool CanDelete
    {
      get
      {
        ...
        if (typeof(YYT.Core.IUndoableObject).IsAssignableFrom(objectType))
        {
          return true;
        }
    ...
    /// <remarks>
    /// If this returns true, the web page must handle the
    /// <see cref="YYTDataSource.InsertObject">InsertObject</see>
    /// event.
    /// </remarks>
    ...
    /// <remarks>
    /// If this returns true, the web page must handle the
    /// <see cref="YYTDataSource.UpdateObject">UpdateObject</see>
    /// event.
    /// </remarks>
