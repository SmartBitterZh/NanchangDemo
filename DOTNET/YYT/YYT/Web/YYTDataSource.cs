...
namespace YYT.Web
{
  ...
  /// YYT .NET business objects as data sources.
  /// </summary>
  [Designer(typeof(YYT.Web.Design.YYTDataSourceDesigner))]
  [DisplayName("YYTDataSource")]
  [Description("YYT .NET Data Source Control")]
  [ToolboxData("<{0}:YYTDataSource runat=\"server\"></{0}:YYTDataSource>")]
  public class YYTDataSource : DataSourceControl
  {

    private YYTDataSourceView _defaultView;
    ...
    protected override DataSourceView GetView(string viewName)
    {
      if (_defaultView == null)
        _defaultView = new YYTDataSourceView(this, "Default");
      return _defaultView;
    }
    ...
    {
      get { return ((YYTDataSourceView)this.GetView("Default")).TypeAssemblyName; }
      set { ((YYTDataSourceView)this.GetView("Default")).TypeAssemblyName = value; }
    }
    ...
    {
      get { return ((YYTDataSourceView)this.GetView("Default")).TypeName; }
      set { ((YYTDataSourceView)this.GetView("Default")).TypeName = value; }
    }
    ...
    /// <see cref="YYT.Core.IReportTotalRowCount"/>.
    /// </remarks>
    public bool TypeSupportsPaging
    {
      get { return ((YYTDataSourceView)this.GetView("Default")).TypeSupportsPaging; }
      set { ((YYTDataSourceView)this.GetView("Default")).TypeSupportsPaging = value; }
    }
    ...
    {
      get { return ((YYTDataSourceView)this.GetView("Default")).TypeSupportsSorting; }
      set { ((YYTDataSourceView)this.GetView("Default")).TypeSupportsSorting = value; }
    }
