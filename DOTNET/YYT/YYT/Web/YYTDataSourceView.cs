...
namespace YYT.Web
{
  ...
  /// to a specific YYT .NET object.
  /// </summary>
  public class YYTDataSourceView : DataSourceView
  {

    private YYTDataSource _owner;
    ...
    /// </summary>
    /// <param name="owner">The YYTDataSource object
    /// that owns this view.</param>
    /// <param name="viewName">The name of the view.</param>
    public YYTDataSourceView(YYTDataSource owner, string viewName)
      : base(owner, viewName)
    {
      _owner = owner;
    }
    ...
    /// <see cref="YYTDataSource.SelectObject"/> event.
    /// </summary>
    ...
    public override bool CanInsert
    {
      get
      {
        if (typeof(YYT.Core.IUndoableObject).IsAssignableFrom(
          YYTDataSource.GetType(_typeAssemblyName, _typeName)))
          return true;
        else
          return false;
      }
    ...
    /// the control by raising the 
    /// <see cref="YYTDataSource.InsertObject"/> event.
    /// </summary>
    ...
    /// the control by raising the 
    /// <see cref="YYTDataSource.UpdateObject"/> event.
    /// </summary>
