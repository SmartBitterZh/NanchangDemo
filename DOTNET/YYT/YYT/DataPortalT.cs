...
namespace YYT
{
  ...
  public class DataPortal<T>
  {
    ...
    private class DataPortalAsyncRequest
    {
      ...
      public YYT.Core.ContextDictionary ClientContext { get; set; }
      public YYT.Core.ContextDictionary GlobalContext { get; set; }
      public object UserState { get; set; }

      public DataPortalAsyncRequest(object argument, object userState)
      {
        this.Argument = argument;
        this.Principal = YYT.ApplicationContext.User;
        this.ClientContext = YYT.ApplicationContext.ClientContext;
        this.GlobalContext = YYT.ApplicationContext.GlobalContext;
    ...
    private class DataPortalAsyncResult
    {
      ...
      public DataPortalAsyncResult(T result, YYT.Core.ContextDictionary globalContext, object userState)
      {
        this.Result = result;
    ...
    {
      YYT.ApplicationContext.User = request.Principal;
      YYT.ApplicationContext.SetContext(request.ClientContext, request.GlobalContext);
    }
    ...
    private YYT.Core.ContextDictionary _globalContext;

    /// <summary>
    /// Gets a reference to the global context returned from
    /// the background thread and/or server.
    /// </summary>
    public YYT.Core.ContextDictionary GlobalContext
    {
    ...
    void Create_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
    {
      ...
      T result = default(T);
      if (state is int)
        result = (T)YYT.DataPortal.Create<T>();
      else
        result = (T)YYT.DataPortal.Create<T>(state);
      e.Result = new DataPortalAsyncResult(result, YYT.ApplicationContext.GlobalContext, request.UserState);
    }
    ...
    private void Fetch_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
    {
      ...
      T result = default(T);
      if (state is int)
        result = (T)YYT.DataPortal.Fetch<T>();
      else
        result = (T)YYT.DataPortal.Fetch<T>(state);
      e.Result = new DataPortalAsyncResult(result, YYT.ApplicationContext.GlobalContext, request.UserState);
    }
    ...
    void Update_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
    {
      ...
      object state = request.Argument;
      T result = default(T);
      result = (T)YYT.DataPortal.Update<T>((T)state);
      e.Result = new DataPortalAsyncResult(result, YYT.ApplicationContext.GlobalContext, request.UserState);
    }
    ...
    private void Delete_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
    {
      ...
      object state = request.Argument;
      YYT.DataPortal.Delete<T>(state);
      e.Result = new DataPortalAsyncResult(default(T), YYT.ApplicationContext.GlobalContext, request.UserState);
    }
    ...
    void Execute_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e) 
    {
      ...
      object state = request.Argument;
      T result = default(T);
      result = YYT.DataPortal.Execute<T>((T)state);
      e.Result = new DataPortalAsyncResult(result, YYT.ApplicationContext.GlobalContext, request.UserState);
    }
