...
namespace YYT
{
    ...
    where T : ReadOnlyBase<T>
  {
    ...
    /// </summary>
    /// <remarks>
    /// AddSharedAuthorizationRules is automatically called by YYT .NET
    ...
    bool YYT.Security.IAuthorizeReadWrite.CanWriteProperty(string propertyName)
    {
      return false;
    }
    ...
    {
      if (CanReadProperty(propertyName, noAccess == YYT.Security.NoAccessBehavior.ThrowException))
        return field;
      else
        return defaultValue;
    }
    ...
    {
      P result = default(P);
      if (CanReadProperty(propertyInfo.Name, noAccess == YYT.Security.NoAccessBehavior.ThrowException))
